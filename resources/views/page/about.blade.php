...
@section('content')
    ...
    <section class="video">
        <iframe width="100%" height="827" src="https://www.youtube.com/embed/7UNIwBtYEDE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </section>
