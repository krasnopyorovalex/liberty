...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="{{ route('admin.sales_leaders.update', ['id' => $salesLeader->id]) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="main">
                            ...
                            @checkbox(['name' => 'show_in_slider', 'label' => 'Отображать коллекцию в слайдере?', 'entity' => $salesLeader])
                                        ...
                                        <div class="panel panel-flat border-blue border-xs" id="image__box">
                                            <div class="panel-body">
                                                ...
                                                <div class="btn-group btn__actions">
                                                    <button type="button" data-href="{{ route('admin.sales_leaders.destroy.img', ['id' => $salesLeader->id]) }}" class="btn delete__img btn-danger btn-labeled btn-labeled-right btn-sm">Удалить <b><i class="icon-trash"></i></b></button>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
                                    ...
                                    @if ($salesLeader->image_mob)
                                        <div class="panel panel-flat border-blue border-xs" id="image__box">
                                            <div class="panel-body">
                                                ...
                                                <div class="btn-group btn__actions">
                                                    <button type="button" data-href="{{ route('admin.sales_leaders.destroy.img.mob', ['id' => $salesLeader->id]) }}" class="btn delete__img btn-danger btn-labeled btn-labeled-right btn-sm">Удалить <b><i class="icon-trash"></i></b></button>
                                                </div>
                                            </div>
                                        </div>
                                    @endif
