...
@section('content')
    ...
    @if(!($searchResult->furniture && $searchResult->furniture->count()) && !($searchResult->portfolios && $searchResult->portfolios->count()) && !($searchResult->doors && $searchResult->doors->count()) && request()->has('keyword'))
        <section>
            <div class="container">
                <div class="row">
                    <div class="col-12">
